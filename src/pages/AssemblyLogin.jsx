...
function AssemblyLogin({ onBack, onLogin }) {
  ...
  return (
    <section className="phone-page form-page">
      ...
      <div className="form-content assembly-content">
        <div className="round-icon round-icon--home" aria-hidden="true">
        ...
        <form className="login-form" onSubmit={(event) => { event.preventDefault(); onLogin?.() }}>
          ...
          <p className="helper-text">Code à 6 chiffres fourni<br />par l’administrateur</p>
        </form>
      </div>
    </section>
  )
